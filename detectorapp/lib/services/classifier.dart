...
class PostureClassifier {
  ...
  Future<void> initialize() async {
    try {
      print('🧠 Cargando modelo Escoliosis Final...');
      _interpreter = await Interpreter.fromAsset(_modelPath);
      _isInitialized = true;
      print('✅ Modelo Escoliosis Final cargado correctamente.');
    } catch (e) {
      print('❌ Error fatal al cargar el modelo Escoliosis Final: $e');
      rethrow;
    }
  }
  ...
  Future<ClassificationResult> classifyPosture(List<double> features) async {
    ...
    try {
      ...
      return ClassificationResult(
        label: 'Error',
        confidence: 0,
        description: 'No se pudo procesar el análisis con el modelo Escoliosis Final.',
        probabilities: [],
      );
    }
  }
  ...
  void dispose() {
    if (_isInitialized) {
      ...
      print('🔒 Clasificador Escoliosis Final liberado.');
    }
  }
}
